...
const iconMap: Record<CameraMotion, ComponentType<{ className?: string }>> = {
  "push-in": ZoomIn,
  "pull-back": ScanSearch,
  "orbit-right-to-left": Orbit,
  "pan-right": ArrowRight,
  "orbit-up": ArrowUpLeft,
  "orbit-down": ArrowDownRight,
  "push-in-zoom-out": MoveDiagonal,
  "pull-back-zoom-in": MoveDiagonal,
};
...
export function CameraMotionSelector({
  ...
  const selectedOption = useMemo(
    () => CAMERA_MOTION_OPTIONS.find((option) => option.id === value) ?? CAMERA_MOTION_OPTIONS[0],
    [value],
  );
      ...
      >
        <div className="flex min-w-0 items-center gap-3">
          ...
          <div className="min-w-0">
            <p className="text-sm font-medium">Chuyển động camera</p>
